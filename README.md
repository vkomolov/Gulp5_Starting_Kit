...
Some useful plugins were omitted because of their vulnerabilities and deprecations...
<br>Some plugins were replaced with the custom modules in `modules` folder.
<br>Anyway, the pack is recommended to add with additional plugins for the operations with the files, images (retina, svg sprites), etc...
